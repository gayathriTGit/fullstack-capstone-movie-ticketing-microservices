package com.nmscinemas.ticket_pricing_service.dto;
...
public class BookingPriceCalcRequest {
    ...
    public BookingPriceCalcRequest(String movieName, Integer noOfTickets, String showTime,
                                   Integer noOfDrinks, Integer noOfPopcorns, Integer noOfIceCream,
                                   Integer noOfCandy, Double baseTicketPrice) {
